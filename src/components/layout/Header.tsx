...
const Header: React.FC<HeaderProps> = ({ className }) => {
  return (
    <header className={cn("bg-card border-b shadow-sm z-10", className)}>
        ...
        <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="hidden md:flex items-center gap-4">
                <Select defaultValue="chennai">
                    <SelectTrigger className="border-none shadow-none focus:ring-0 gap-1 font-medium text-sm text-foreground">
      ...
      <nav className="h-10 bg-card flex items-center justify-between px-6 border-t xl:border-none">
        <div className="flex items-center gap-6 text-sm font-medium text-muted-foreground">
            ...
            <a href="#" className="text-primary font-semibold">Activities</a>
        </div>
